...
/**
 * A DTO for the MyProcess entity.
 */
public class MyProcessDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        MyProcessDTO myProcessDTO = (MyProcessDTO) o;
        if(myProcessDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), myProcessDTO.getId());
    }
