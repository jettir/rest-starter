...
/**
 * A DTO for the MyEvent entity.
 */
public class MyEventDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        MyEventDTO myEventDTO = (MyEventDTO) o;
        if(myEventDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), myEventDTO.getId());
    }
