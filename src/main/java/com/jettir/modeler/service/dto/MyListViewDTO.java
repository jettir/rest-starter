...
/**
 * A DTO for the MyListView entity.
 */
public class MyListViewDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        MyListViewDTO myListViewDTO = (MyListViewDTO) o;
        if(myListViewDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), myListViewDTO.getId());
    }
