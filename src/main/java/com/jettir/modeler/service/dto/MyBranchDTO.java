...
/**
 * A DTO for the MyBranch entity.
 */
public class MyBranchDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        MyBranchDTO myBranchDTO = (MyBranchDTO) o;
        if(myBranchDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), myBranchDTO.getId());
    }
