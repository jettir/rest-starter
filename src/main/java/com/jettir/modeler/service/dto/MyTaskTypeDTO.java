...
/**
 * A DTO for the MyTaskType entity.
 */
public class MyTaskTypeDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        MyTaskTypeDTO myTaskTypeDTO = (MyTaskTypeDTO) o;
        if(myTaskTypeDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), myTaskTypeDTO.getId());
    }
