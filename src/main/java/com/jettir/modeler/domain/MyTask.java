...
public class MyTask implements Serializable {
    ...
    public MyTask name(String name) {
        this.name = name;
        return this;
    }
    ...
    public MyTask created(Instant created) {
    ...
    public MyTask modified(Instant modified) {
    ...
    public MyTask modifiedBy(String modifiedBy) {
    ...
    public MyTask createdBy(String createdBy) {
    ...
    public MyTask myBranch(MyBranch myBranch) {
    ...
    public MyTask myRelease(MyRelease myRelease) {
    ...
    public boolean equals(Object o) {
        ...
        if (myTask.getId() == null || getId() == null) {
            return false;
        }
